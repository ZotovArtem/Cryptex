 ...
 * It is the starting point which actually initialize all scenes and renders it.
            ...
            if (MainMenuScreen.globalReferences.getItemsWeCanCollect1Level() == 0) {
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            synchronized (this) {
                                MainMenuScreen.saving.setFlagLoad1(false);
                                MainMenuScreen.saving.setFlagLoad2(false);
                                MainMenuScreen.saving.setFlagLoad3(false);
                                MainMenuScreen.saving.setFlagLoad4(false);
                                MainMenuScreen.saving.setFlag1LOADED(false);
                                MainMenuScreen.saving.setFlag2LOADED(false);
                                MainMenuScreen.saving.setFlag3LOADED(false);
                                MainMenuScreen.saving.setFlag4LOADED(false);
                                wait(2000);
